...
- [**Synchronize Data from Postgres to Elasticsearch**](#Synchronize)
...
### [**3.2 Nên nhớ 7 + 1 từ khóa nên nhớ về Kafka**](#kafka)
<details>
  <summary><strong>Xem thêm</strong></summary>
...
## [**5. Synchronize Data from Postgres to Elasticsearch**](#Synchronize)

### [**5.1 Synchronous**](#synchronous)
 > Cần bổ sung
### [**5.2 Asynchronous**](#asynchronous)
> Cần bổ sung
...
### [**6.2 Using docker-compose.yml**](#using-docker-composeyml)
  ```yaml
version: '3.8'
